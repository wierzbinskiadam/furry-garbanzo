...
describe("EventTemplate", () => {
  ...
  test("POST /event-templates", async () => {
  ...
  test("GET /event-templates", async () => {
    await request(app.getHttpServer())
      .get("/event-templates")
  ...
  test("GET /event-templates/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/event-templates"}/${nonExistingId}`)
      .expect(404)
      .expect({
        statusCode: 404,
  ...
  test("GET /event-templates/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/event-templates"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
